...
export default function ArticleFilter() {
  ...
  return (
    <>
      <Head>
        {cat_id === '0' && <title>所有文章</title>}
        {cat_id === '1' && <title>公告</title>}
        {cat_id === '2' && <title>開箱文</title>}
        {cat_id === '3' && <title>組裝教學</title>}
        {cat_id === '4' && <title>活動</title>}
      </Head>
      <div className="container mt-sm-5 mt-3" style={{ minHeight: 525 }}>
        {/* 手機版搜尋欄 */}
